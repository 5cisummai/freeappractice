...
vi.mock('$lib/questions/pool-write.server', () => ({ generateQuestionForPool: vi.fn() }));
vi.mock('$lib/frq/generation.server', () => ({ generateAndPersistFrq: vi.fn() }));
...
import type { PoolRefillState } from '$lib/questions/pool-refill-types.server';
