<script lang="ts">
	...
	const superFeatures = [
		...
		'AI Coach with approval-based study-plan updates',
		'Actionable insights and weekly study plans',
		'600 personalized messages per UTC calendar month'
	];
</script>
...
<div class="mx-auto grid max-w-4xl gap-5 md:grid-cols-2">
	...
	<article
		class="flex flex-col rounded-3xl border-2 border-violet-300/50 bg-linear-to-r from-violet-500/10 via-fuchsia-500/10 to-cyan-400/10 p-7 shadow-sm shadow-violet-500/10"
	>
		<div class="flex items-start justify-between gap-3">
			<div>
