		...
		<div class="prose prose-neutral dark:prose-invert max-w-none space-y-6 text-base leading-7">
			...
			<section>
				...
				<p>
					...
					for sign-in and Google One Tap, Neon-hosted PostgreSQL for database storage, Desmos for
					calculator functionality, Resend for transactional emails, PostHog for optional product
					analytics, Vercel for hosting and infrastructure, Sentry for error and performance
