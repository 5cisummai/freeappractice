		...
		<div class="prose prose-neutral dark:prose-invert max-w-none space-y-6 text-base leading-7">
			...
			<section>
				...
				<p>
					...
					for sign-in and Google One Tap, MongoDB for database storage, AWS S3 for file storage,
					Desmos for calculator functionality, Resend for transactional emails, PostHog for optional
					product analytics, Vercel for hosting and infrastructure, Sentry for error and performance
					monitoring, Stripe for payments and taxes, Mem0 for optional tutor memory, Upstash for
					short-lived service controls, and GitHub for bug-report handling. Those providers may
					process data according to their own terms and privacy policies. We are not responsible for
