...
If you're still deciding which APs to take, read [Which APs Should You Take?](/blog/which-aps-to-take) first. Picking the right classes matters more than previewing the wrong ones.
...
1. **2 min:** Pick subject + unit (start with Unit 1).
2. **12 min:** Answer 3–5 practice questions without peeking.
3. **6 min:** Read explanations and note one idea to revisit tomorrow.
...
Use Free AP Practice for **active practice** after you've seen Unit 1 once. Select your AP class, choose Unit 1, and practice questions until explanations make sense without rereading the prompt three times.
