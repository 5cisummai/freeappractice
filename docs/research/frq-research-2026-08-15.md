...
The current profile’s guidance to separate setup/method credit from arithmetic accuracy is correct, but too general. The generator and grader must know *which* method, notation, theorem condition, or global argument is required for each part.
